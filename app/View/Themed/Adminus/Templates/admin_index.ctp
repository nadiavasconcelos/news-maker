					...
					<?php foreach($templates as $key => $template) : ?>
						<tr class="grid-item strip-<?php echo $count % 2; ?>">
							...
							<td width="160">
								...
								<?php echo $this->Html->link('<i class="icon-th icon-white"></i>', array('action' => 'edit', $template['Template']['id']), array('title' => 'Newsletters', 'escape' => false, 'class' => 'btn btn-small btn-info')); ?>
							</td>
						</tr>
						<?php $count++ ?>
					<?php endforeach; ?>
